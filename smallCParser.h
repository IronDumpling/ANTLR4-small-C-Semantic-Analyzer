...
public:
  ...
  enum {
    ...
    RuleFcnDecl = 8, RuleVarType = 9, RuleRetType = 10, RuleScope = 11, 
    RuleStmt = 12, RuleAssignStmt = 13, RuleIfStmt = 14, RuleWhileStmt = 15, 
    RuleRetStmt = 16, RuleExpr = 17, RuleIntExpr = 18, RuleConstant = 19, 
    RuleBoolConst = 20, RuleIntConst = 21, RuleParams = 22, RuleParamEntry = 23, 
    RuleParamList = 24, RuleArgs = 25, RuleArgEntry = 26, RuleArgList = 27, 
    RuleVar = 28, RuleVarName = 29, RuleArrName = 30, RuleFcnName = 31
  };
  ...
  public:
    std::vector<smallc::ArrayDeclNode *>* declList;
  ...
  public:
    smallc::PrimitiveTypeNode * variableType;
  ...
  public:
    smallc::PrimitiveTypeNode * returnType;
    smallCParser::VarTypeContext *varTypeContext = nullptr;;
  ...
  public:
    smallc::AssignStmtNode * assStatement;
  ...
  public:
    smallc::WhileStmtNode * whileStatement;
    smallCParser::ExprContext *exprContext = nullptr;;
    smallCParser::StmtContext *stmtContext = nullptr;;
  ...
  public:
    smallc::ReturnStmtNode * retStatement;
    smallCParser::ExprContext *exprContext = nullptr;;
  ...
  public:
    smallc::IntExprNode * intExpression;
  ...
  public:
    smallc::ConstantExprNode * const_;
  ...
  public:
    smallc::BoolConstantNode * boolConstant;
  ...
  public:
    smallc::IntConstantNode * intConstant;
  ...
  public:
    smallc::ParameterNode * parameter;
    smallCParser::VarTypeContext *varTypeContext = nullptr;;
    smallCParser::VarNameContext *varNameContext = nullptr;;
    smallCParser::ArrNameContext *arrNameContext = nullptr;;
  ...
  public:
    smallc::ReferenceExprNode * variable;
    smallCParser::VarNameContext *varNameContext = nullptr;;
    smallCParser::ArrNameContext *arrNameContext = nullptr;;
    smallCParser::IntExprContext *intExprContext = nullptr;;
  ...
  public:
    smallc::IdentifierNode * variableName;
  ...
  public:
    smallc::IdentifierNode * arrayName;
    antlr4::Token *idToken = nullptr;;
  ...
  public:
    smallc::IdentifierNode * functionName;
    antlr4::Token *idToken = nullptr;;
